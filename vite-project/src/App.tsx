...
export default function App() {
  ...
  const timelineEvents = [
    ...
    { date: "03.29.25", description: "raises $850 dollars from friend (currently working at Google)" },
    ...
    { date: "06.01.24", description: "Informs Dad of wanting to take a gap year before college to do a coding bootcamp and subsquently gets kicked out and becomes homeless for 3 days. " },
